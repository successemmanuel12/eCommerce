...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    private void deleteThisProduct() {
        productRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                finish();
                Toast.makeText(AdminMaintainProductsActivity.this,"The Product has Been Successfully Deleted",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void applyChanges() {
        ...
        if (pName.equals("")) {
            ...
            Toast.makeText(AdminMaintainProductsActivity.this, "Please Enter Product Full Description", Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            productRef.updateChildren(productMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        Toast.makeText(AdminMaintainProductsActivity.this, "Changes Successfully applied", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(AdminMaintainProductsActivity.this, AdminCategoryActivity.class));
                    }
                }
            });
